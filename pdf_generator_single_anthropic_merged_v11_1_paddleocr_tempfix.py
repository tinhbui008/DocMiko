...
# -*- coding: utf-8 -*-
"""
pdf_generator_single_anthropic_merged_v11_1_paddleocr_tempfix.py
...
Run:
    python pdf_generator_single_anthropic_merged_v11_1_paddleocr_tempfix.py input.pdf output.pdf `
...
# VERSION_MARKER = 'merged_v11_1_paddleocr_tempfix'
# ==================== V8 CORE ====================
import argparse
import copy
import json
...
def get_paddle_ocr_engine_v11(lang: str = "en", use_textline_orientation: bool = False):
    ...
    Supports both PaddleOCR 3.x and older 2.x constructor signatures.
    """
    ...
    print(f"      Initializing PaddleOCR engine lang={plang} textline_orientation={use_textline_orientation}")
