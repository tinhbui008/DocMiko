...
# -*- coding: utf-8 -*-
"""
pdf_generator_single_anthropic_merged_v10_ocr.py
...
Run:
    python pdf_generator_single_anthropic_merged_v10_ocr.py input.pdf output.pdf `
...
# VERSION_MARKER = 'merged_v10_ocr_fallback'
# ==================== V8 CORE ====================
import argparse
import copy
import json
...
def build_arg_parser_v6() -> argparse.ArgumentParser:
    ...
    p.add_argument("--ocr-lang", default="eng", help="Tesseract OCR language, default: eng")
    ...
    p.add_argument("--tesseract-cmd", default=None, help="Path to tesseract.exe on Windows")
    return p
...
def draw_ocr_block_v10(
    ...
    if role == "title":
        fontfile = title_font or condensed_bold_font or bold_font or regular_font
        fontname = "FOCRTitle"
    elif role == "label":
        fontfile = condensed_bold_font or condensed_font or bold_font or regular_font
        fontname = "FOCRLabel"
    elif bold_font:
