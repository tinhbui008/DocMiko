...
# -*- coding: utf-8 -*-
"""
pdf_generator_single_anthropic_merged_v14_patch_only.py
...
Run:
    python pdf_generator_single_anthropic_merged_v14_patch_only.py input.pdf output.pdf `
...
# VERSION_MARKER = 'merged_v14_patch_only_targeted'
# ==================== V8 CORE ====================
import argparse
import copy
import json
...
def main_v6(argv: Optional[List[str]] = None):
    ...
    if args.patch_only_from:
        print(f"[Patch-only] Apply targeted patches on: {args.patch_only_from}")
